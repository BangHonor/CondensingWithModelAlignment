        ...
        *,
        ...
        for i in range(self.nlayers):
            ...
            if self.supports_edge_weight and self.supports_edge_attr:
                ...
                x = self.convs[i](x, edge_index, edge_weight=edge_weight, syn=syn)
            elif self.supports_edge_attr:
                x = self.convs[i](x, edge_index, edge_attr=edge_attr, syn=syn)
            else:
...
class GCN(BasicGNN):
    ...
    def init_conv(self, nfeat: int, nclass: int,
        ...
        return GCNConv(nfeat, nclass, normalize=True, add_self_loops=True, cached=self.cached, **kwargs)
...
class GraphSAGE(BasicGNN):
    ...
    def init_conv(self, nfeat: Union[int, Tuple[int, int]],
                  nclass: int, **kwargs) -> MessagePassing:
        return SAGEConv(nfeat, nclass, normalize=True, add_self_loops=True, cached=self.cached, **kwargs)
...
class GIN(BasicGNN):
    ...
    def init_conv(self, nfeat: int, nclass: int,
        ...
        return GINConv(mlp, normalize=True, add_self_loops=True, cached=self.cached, **kwargs)
...
class SGC(BasicGNN):
    ...
    def init_conv(self, nfeat: int, nclass: int, 
                  **kwargs) -> MessagePassing:
        return SGConv(nfeat, nclass, K=3, normalize=True, add_self_loops=True, cached=self.cached, **kwargs)
